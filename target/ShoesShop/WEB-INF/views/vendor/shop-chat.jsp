...
<%-- Lấy user trong session: ưu tiên currentUser, fallback user --%>
...
<%-- THÊM CSS ĐỂ LÀM GIÃN DÒNG CHAT --%>
<style>
    /* Áp dụng lề dưới cho mỗi thẻ div (tin nhắn) bên trong chatBox */
    #chatBox > div {
        margin-bottom: 6px; /* Điều chỉnh 6px để có khoảng cách vừa phải */
    }
</style>
