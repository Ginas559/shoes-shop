          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table align-middle">
                ...
                <tfoot>
                  <!-- Giảm giá nếu có -->
                  <c:if test="${not empty sessionScope.voucherDiscount && sessionScope.voucherDiscount > 0}">
                    <tr>
                      <th colspan="3" class="text-end text-success">Giảm giá:</th>
                      <th class="text-end text-success">
                        −<fmt:formatNumber value="${sessionScope.voucherDiscount}" type="currency" currencySymbol="₫" />
                      </th>
                    </tr>
                  </c:if>
                  <tr>
            ...
            <div class="mt-3">
              ...
              <div class="input-group">
                ...
                <button type="button" id="applyVoucherBtn" class="btn btn-outline-success">Áp dụng</button>
              </div>
  ...
  if (applyBtn) {
    applyBtn.addEventListener('click', () => {
      ...
      .then(data => {
        ...
        if (data.success) {
          msg.textContent = `✅ ${data.message || 'Áp dụng thành công!'}`;
