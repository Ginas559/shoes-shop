...
<form class="row g-2 mb-3" method="get" action="${ctx}/vendors">
  <div class="col-12 col-md-6">
    <input class="form-control" name="q" value="${q}" placeholder="Tìm theo tên shop...">
  </div>
...
<c:choose>
          ...
          <div class="card h-100 vendor-card">
            ...
            <div class="card-body">
              <div class="mb-2">
                ...
                <div class="text-muted small line-clamp-2" style="min-height: 2.8em;">
                  <c:out value="${empty s.description ? 'Chưa có mô tả.' : s.description}"/>
                </div>
              </div>
      ...
      <nav class="mt-3">
        <ul class="pagination justify-content-center">
          <li class="page-item ${currPage>1 ? '' : 'disabled'}">
            <a class="page-link" href="<c:url value='/vendors'>
  ...
  <c:otherwise>
    <div class="text-center text-muted py-5">Chưa có shop để hiển thị.</div>
  </c:otherwise>
</c:choose>